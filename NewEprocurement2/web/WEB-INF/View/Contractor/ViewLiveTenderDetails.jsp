                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${tenderDocument}" var="tenderDocument">
                                                    <tr>
                                                        ...
                                                        <td><span class="rs_ic"><a href="<c:out value='${tenderDocument.doc_Path}'/>" class="k-link" target="_blank">View</a>
</span></td>
                                                    </tr>
                                                </c:forEach> 
                                            </tbody>
                                    ...
                                    <table class="table table-striped- table-bordered table-hover table-checkable ">
                                        <tbody>
                                            <tr class="text-center">
                                                <td colspan="5"><span class="rs_ic">
                                                        <button type="reset" class="btn btn-primary btn-sm" data-toggle="modal" data-toggle="modal" data-target="#createTenderWizard" onclick="$('#step8').click();">Tender Notice</button></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
