...
<div class="modal fade mdl_bg mdl_frm" id="create_passwordsdeptUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="k-login-v2__body-container">
                                                ...
                                                <form class="k-login-v2__body-form k-form k-login-v2__body-form--border" id="veryfyPassword1" action="createNewPassword" autocomplete="off" > 
                                                    <div class="form-group">
                                                        <input type="hidden" name="reg_Id" value="${reg_Id}" class="reg_Id">
                                                        <input class="form-control" type="password" placeholder="New Password" id="newEnteredPassword1" name="password" autocomplete="off">
                                                                <span class="form-text validateField" id="newEnteredPasswordError1"></span>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input class="form-control" type="password" placeholder="Confirm Password" id="confirmNewPassword1" name="cPassword" autocomplete="off">
...
<!--                                                                <div class="k-login-v2__body-separator">
             ...
             function validPassword(value){
                 ...
                 if(!password_pattern.test(value)){
                    ...
                    document.getElementById("newEnteredPasswordError1").innerHTML="Enter Valid Password<br>Password Should Contains at least  8 characters , one number, one lowercase and one uppercase letter";  
                     return false;
                }else{
...
//               
                if (confirmPassword == "") {
                 ...
                 document.getElementById("confirmNewPasswordError1").innerHTML="Please Enter Password";    
                    return false;
                }
