...
<body class="k-header--fixed k-header--skin-default k-header-mobile--skin-default k-header-mobile--fixed k-aside--enabled k-aside--fixed k-aside--skin-default k-aside__brand--skin-default k-aside-secondary--enabled" ng-controller="MainCtrl">
    ...
    <!-- Large Modal -->
  <jsp:include page="Tiles/TenderAmmendmentWizard.jsp"/>
...
<!--                                <div class="k-portlet__head">
           ...
           <div class="k-portlet__body">
               <form:form modelAttribute="tender" action="amendmentTenderCreation" enctype="multipart/form-data"  id="validateAmmendment"> 
...
<%--                <div class="edit_tender_bt">
                    <button type="reset" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createTenderWizard" onclick="$('#step2').click();" ng-click="fetchTenderDetails(${tender.tender_Id});"><i class="flaticon-edit"></i>Edit</button>
                </div>--%>
            </div>
            ...
            <div class="devider_boxed border_boxesDiv">
                <div class="k-portlet__head">
                    <div class="k-portlet__head-label">
                        ...
                        <h3 class="k-portlet__head-title">
			<input type="hidden" name="tender_Id" id="tender_Id" value="${tender.tender_Id}" />Tender Details										<!-- <small>some sub title</small> -->
												</h3>
                    </div>
                </div>
                <!-- <div class="k-content__head-main"> -->
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable ">
                    <tbody>
                        <tr>
                            ...
                            <td><span class="rs_ic"><c:out value="${tender.nameOfWork}"/>
                                    <form:hidden path="nameOfWork" value="${tender.nameOfWork}"/></span></td>
                            <th><span class="dwn_arrow">Short Description</span></th>
                            <td><span class="rs_ic"><c:out value="${tender.descriptionOfWork}"/><form:hidden path="descriptionOfWork" value="${tender.descriptionOfWork}"/></span></td>
                        </tr>
<!--                        <tr>
                            <th><span class="dwn_arrow">Short Description</span></th>
                        ...
                        <tr>-->
                            ...
                            <td><span class="rs_ic"><i class="fa fa-rupee"></i><c:out value="${tender.estimateValueInFig}"/><form:hidden path="estimateValueInFig" value="${tender.estimateValueInFig}"/></span></td>
                            <th><span class="dwn_arrow">Estimate Value (In words)</span></th>
                            <td colspan="3"><span class="rs_ic"><i class="fa fa-rupee"></i><c:out value="${tender.estimateValueInWord}"/><form:hidden path="estimateValueInWord" value="${tender.estimateValueInWord}"/></span></td>
                        </tr>
                        <tr>
                            <th><span class="dwn_arrow">Tender Fees (In figure)</span></th>
                            <td><span class="rs_ic"><i class="fa fa-rupee"></i><c:out value="${tender.tenderFeeInFig}"/><form:hidden path="tenderFeeInFig" value="${tender.tenderFeeInFig}"/></span></td>
                            <th><span class="dwn_arrow">Tender Fees (In words)</span></th>
                            <td colspan="3"><span class="rs_ic"><i class="fa fa-rupee"></i><c:out value="${tender.tenderFeeInWord}"/><form:hidden path="tenderFeeInWord" value="${tender.tenderFeeInWord}"/></span></td>
                        </tr>
                        <tr>
                            <th><span class="">Bid Validate Period</span></th>
                            <td><span class=""><c:out value="${tender.bidValidatePeriod}"/><form:hidden path="bidValidatePeriod" value="${tender.bidValidatePeriod}"/></span></td>
                            <th><span>Bid Validate Type</span></th>
                            <td><span><c:out value="${tender.bidValidateType}"/><form:hidden path="bidValidateType" value="${tender.bidValidateType}"/></span></td>
                        </tr>
                        <tr>
                            <th><span class="">Work Completion Period</span></th>
                            <td><span class=""><c:out value="${tender.workCompletionPeriod}"/><form:hidden path="workCompletionPeriod" value="${tender.workCompletionPeriod}"/></span></td>
                            <th><span class="">Work Completion Type</span></th>
                            <td><span class=""><c:out value="${tender.workCompletionType}"/><form:hidden path="workCompletionType" value="${tender.workCompletionType}"/></span></td>
                ...
                <div class="edit_tender_bt">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createTenderWizard" onclick="$('#step3').click();" ng-init="ammendButton = 'false'"><i class="flaticon-edit"></i>Edit</button>
                </div>
            </div>
            ...
            <div class="devider_boxed border_boxesDiv">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable ">
                    <tbody>
                        ...
                        <c:if test="${tender.typeOfTender!='4'}">
                            <tr>
...
<%--                <div class="edit_tender_bt">
                    <button type="reset" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createTenderWizard" onclick="$('#step4').click();" ng-click="fetchTenderDetails(${tender.tender_Id});"><i class="flaticon-edit"></i>Edit</button>
                </div>--%>
            </div>
            ...
            <div class="devider_boxed border_boxesDiv">
                ...
                <!-- <div class="k-content__head-main"> -->
                <!-- <h3 class="tender_head text-white">Dynamic Templates</h3>  -->
                <!-- </div> -->
...
<c:out value="${envelopeA.firstName}"/>   <c:out value="${envelopeA.lastName}"/> ,
                                            </c:forEach>
    </span></td>
                        ...
                        <tr>
                            ...
                            <td class="table_wth-60"><span class="rs_ic">Vaishali Gupta</span></td>
                            <td class="table_wth-18"><span class="rs_ic"><a href="#" class="k-link"> View Template</a></span></td>
                        </tr>
...
<td colspan="2"><span class="rs_ic"><c:forEach items="${tender.ammendmentPrivilegeOfficerList}" var="ammendmentOfficer">  <c:out value="${ammendmentOfficer.firstName}"/>  <c:out value="${ammendmentOfficer.lastName}"/>,&nbsp;                                                      
            ...
            <div class="devider_boxed border_boxesDiv">
                ...
                <div class="edit_tender_bt">
                    <button type="button" data-toggle="modal" data-target="#createTenderWizard" class="btn btn-primary btn-sm" onclick="$('#step6').click();" ng-init="ammendButton = 'false'"><i class="flaticon-edit"></i>Edit</button>
<!--                     <a href="zipfile?tender_Id=${tender.tender_Id}&fileName=doc.zip" class="btn btn-primary btn-sm">Zip File</a>-->
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable ">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time"><c:out value="${tenderKeyDateses.tenderPurchaseDate}"/><form:hidden path="tenderKeyDates.tenderPurchaseDate" value="${tenderKeyDateses.tenderPurchaseDate}"/> </span></td>
                        </tr>
                        <tr>
                            <td><span class="rs_ic">2</span></td>
                            <td><span class="rs_ic">BID SUBMISSION</span></td>
                           <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time"><c:out value="${tenderKeyDateses.bidSubmissionDate}"/><form:hidden path="tenderKeyDates.bidSubmissionDate" value="${tenderKeyDateses.bidSubmissionDate}"/></span></td>
                        </tr>
                        <tr>
                            <td><span class="rs_ic">3</span></td>
                            <td><span class="rs_ic">OPENING(EA)</span></td>
                            <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time"><c:out value="${tenderKeyDateses.openingEA}"/><form:hidden path="tenderKeyDates.openingEA" value="${tenderKeyDateses.openingEA}"/></span></td>
                        </tr>
                        <tr>
                            <td><span class="rs_ic">4</span></td>
                            <td><span class="rs_ic">OPENING(EB)</span></td>
                            <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time"><c:out value="${tenderKeyDateses.openingEB}"/><form:hidden path="tenderKeyDates.openingEB" value="${tenderKeyDateses.openingEB}"/></span></td>
                        </tr>
    ...
    <c:otherwise>
        <c:if test="${tenderKeyDateses.ecBidSubmissionDate != ''}">
            <tr>
                <td><span class="rs_ic">5</span></td>
                <td><span class="rs_ic">(EC)BID SUBMISSION </span></td>
                <td colspan="2">
                    <i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i>
                    <span class="start_date pd_right date_time">
                        <c:out value="${tenderKeyDateses.ecBidSubmissionDate}"/>
                        <form:hidden path="tenderKeyDates.ecBidSubmissionDate" value="${tenderKeyDateses.ecBidSubmissionDate}"/>
                    </span>
                </td>
            </tr>
        </c:if>
        <c:if test="${tenderKeyDateses.ecBidSubmissionDate == ''}">
            <tr>
                ...
                <td colspan="2">
                    <i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i>
                    <span class="start_date pd_right date_time">Opening EC after technical Bid
                        <form:hidden path="tenderKeyDates.ecBidSubmissionDate" value="${tenderKeyDateses.ecBidSubmissionDate}"/>
                    </span>
                </td>
            </tr>
                        ...
                        <c:if test="${tenderKeyDateses.openingEC!=''}">
                        <tr>
                            <td><span class="rs_ic">6</span></td>
                            <td><span class="rs_ic">OPENING(EC)</span></td>
                           <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time"><c:out value="${tenderKeyDateses.openingEC}"/><form:hidden path="tenderKeyDates.openingEC" value="${tenderKeyDateses.openingEC}"/></span>
							</td>
                        </tr>
                        </c:if>
                        <c:if test="${tenderKeyDateses.openingEC==''}">
                          <tr>
                            <td><span class="rs_ic">6</span></td>
                            <td><span class="rs_ic">OPENING(EC)</span></td>
                           <td colspan="2"><i class="flaticon-calendar-with-a-clock-time-tools pull-left"></i><span class="start_date pd_right date_time">Opening EC after technical Bid<form:hidden path="tenderKeyDates.openingEC" value="${tenderKeyDateses.openingEC}"/></span>
							</td>
                        </tr>  
                        </c:if>
                    </tbody>
                ...
                <div class="edit_tender_bt">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createTenderWizard" class="btn btn-primary btn-sm" onclick="$('#step7').click();" ng-init="ammendButton = 'false'"><i class="flaticon-edit"></i>Edit</button>
                </div>
            </div>
</c:forEach>
                     ...
                     <table class="table table-striped- table-bordered table-hover table-checkable ">
                         <tbody>
                             <tr class="text-center">
                                 <td colspan="5"><span class="rs_ic"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-toggle="modal" data-target="#createTenderWizard" onclick="$('#step8').click();" ng-init="ammendButton = 'true'">Tender Notice</button></span></td>
                             </tr>
                         </tbody>
                     </table>
                 </div>
            <form:hidden path="tenderStatus" value="${tender.tenderStatus}" ng-model="tenderStatus" id="tenderStatus"/> 
                      
                 
<c:if test="${tender.tenderStatus.equalsIgnoreCase('Approved') || tender.tenderStatus.equalsIgnoreCase('Amended')}">
  
<div class="button_section text-center ">  
   <c:if test="${processToAmmendmentButton != null}"> 
   <c:if test="${processToAmmendmentButton.equalsIgnoreCase('show')}">
    <a href="#" class="btn btn-success" ng-click="managehideAndShow('Show Ammendment Button')">Proceed To Ammendment</a>
   </c:if>      
   </c:if>  
    <c:if test="${processToAmmendmentButton == null}">
    <a href="#" class="btn btn-success" title="Please Amend Alteast One details">Proceed To Ammendment</a>
   </c:if> 
    <a href="tenderStatusManaging/Canceled/${tender.tender_Id}" class="btn btn-warning">Cancellation Tender</a>
    <a href="#" class="btn btn-secondary exit_bt btn-outline-hover-danger" ng-click="discardChangesButton(${tender.tender_Id});">Discard Changes</a>
    <!--eTendering-->
    <c:if test="${tender.tenderStatus.equalsIgnoreCase('Amended')}">
    <a href="#" class="btn btn-info exit_bt pull-right" data-toggle="modal" data-target="#m_select_modal_view_Amendment_History" ng-click="tenderAmendmentHistory(${tender.tender_Id});">History</a>
    </c:if>
</div>
...
<span ng-hide="ammendmentButton">
        ...
        <div class="k-portlet__head">
            <div class="k-portlet__head-label">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable ">
                    <tbody>
                        <tr>
                            <th colspan="2"><span class="dwn_arrow">Remark<span style="color:red;">*</span></span></th>
                        </tr>
			<tr> 
                            <td colspan="2"><span class="rs_ic"><form:textarea  path="remarks" cols="80" rows="10" cssStyle="height: 100px;" cssClass="form-control" placeholder="Mention Your Note" id="remarks"/></span><span id="remarksError" class="errorColor"></span> </td> 
                        </tr>
			<tr> 
                            <td>Corrigendum Type<span style="color:red;">*</span></td> 
                            <td><form:select path="ammendmentCorrigendum" id="corrigendumType" cssClass="form-control"  ><form:option value="0">Select</form:option><form:option value="Date Corrigendum">Date Corrigendum</form:option><form:option value="Document Corrigendum">Document Corrigendum</form:option><form:option value="Date and Document Corrigendum">Date and Document Corrigendum</form:option></form:select><span id="corrigendumTypeError" class="errorColor"></span></td>   
                        </tr>
                         
			<tr> 
                            <td><span class="rs_ic">Document Upload</span></td> 
                            <td><span class="rs_ic"><div class="custom-file">
        <input name="statusFiles" type="file" class="custom-file-input" id="couldFolderFile2">
            <label class="custom-file-label" for="customFile" id="remakeChooseFile">Choose file</label>        </div></span></td> 
                        </tr>
                     </tbody>
                </table>
            </div>
   ...
   <div class="button_section text-center "> 
       <!--<a href="javascript:ammendTenderProcess(${tender.tender_Id});" class="btn btn-success">Approved</a>-->
                                <button type="submit" class="btn btn-success" onclick="ammendTenderProcess(${tender.tender_Id})" >Ammend</button> 
   </div>
</span>
...
$('#slider_example_2').datetimepicker(
    ...
    <script>
     $(document).ready(function(){   
        $("#validateAmmendment").submit(function(){
         var remarks = $("#remarks").val();
         var corrigendumType = $("#corrigendumType").val();
         //alert(remarks+":"+corrigendumType);
         
         //Remark Validation
         if(remarks===""){
            $("#remarksError").html("Remark is Mandatory"); 
            return false;
         }else{
            $("#remarksError").html("");  
         }
         
         //Corrigendum Type Validation
         if(corrigendumType==="0"){
           $("#corrigendumTypeError").html("Corrigendum Type is Mandatory"); 
            return false;  
         }else{
           $("#corrigendumTypeError").html("");   
         }
        ...
        $(document).ready(function(){
            ...
            var bidValidateType = '<c:out value="${tender.bidValidateType}"/>';
            //alert(bidValidateType);
            if(bidValidateType === 'Days'){
             $("#bidValidateType").val(1);
            }
            if(bidValidateType === 'Month'){
             $("#bidValidateType").val(2);
            }
            var workCompletionType = '<c:out value="${tender.workCompletionType}"/>';
            if(workCompletionType === 'Days'){
             $("#workCompletionType").val(1);
            }
            if(workCompletionType === 'Month'){
             $("#workCompletionType").val(2);
            }
        });
...
//          });
            ...
            alert("Sequence Id" + id);
             ...
             var tenderid = "";
        function ammendTenderProcess(tenderId) {
                $('#preloaderSpinner').show();
                randomNo = getRandomInt(1, 300000);
                randomNo = randomNo + "TAB";
                var url = "AmmendTenderProcess?randomNo=" + randomNo;
                window.open(url);
                tenderid = tenderId;
                    ...
                    success: function (response) {
                        ...
                        if (data[0] == 'success' && data[1] == 'active') {
                            ...
                            if (randomNo.indexOf('NEWTAB') > -1) { // open url in new tab
                                ...
                                alert("tenderId : "+tenderid);
                                window.location.href = "tenderStatusManaging/Ammeded/"+tenderid;
                            }
                        } else {
