        ...
        <div class="k-grid k-grid--hor k-grid--root">
            <div class="k-grid__item k-grid__item--fluid k-grid k-grid--ver k-page">
                ...
                <div class="k-aside  k-aside--fixed k-aside--skin-default 	k-grid__item k-grid k-grid--desktop k-grid--hor-desktop" id="k_aside">
                    ...
                    <!-- begin:: Aside Menu -->
                    <jsp:include page="Tiles/Asidemenu.jsp"/>
                    <!-- end:: Aside -->
                </div>
...
<!--         <div class="container">
            <div class="modal fade" id="myModaldetail" role="dialog">
                <div class="modal-dialog">
                    ...
                    Model to check department user Information
                     Modal content
                    <div class="modal-content">
                        <div class="modal-header1">
                            <button type="button" class="close" id="closemodal" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title categoryTitle"><img src="/NewEprocurement/resources/images/demo.png" alt="modal_logo">DepartmentUser Registration</h4>
                        </div>
                        <div class="modal-body">
                            <div class="subdivisoncreate">
                                ...
                                <div class="col-md-12 valid">
                                    ...
                                    <%--<form:form  class="registerForm" modelAttribute="departmentUser" action="checkdepartment" id="form" enctype="multipart/form-data" >--%>
                                        <div class="inputfield_division">
                                            <form action="#" class="createdivison">
                                                <div class="form-group row">
                                                    <label for="inputSubdivision" class="col-sm-4 col-form-label">Email</label>
                                                    <div class="col-sm-8"><span id="errorEmail"></span>
...
Vikalp SVG End                     </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputSubdivision" class="col-sm-4 col-form-label">Mobile No.</label>
                                                    <div class="col-sm-8"><span id="errorMobile_no"></span>
...
Vikalp SVG End                       </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <button type="button" class="btn btn-success" id="saveDept" onclick="checkdeptinfo();" data-toggle="modal" data-target="#myModaldetail1">Submit</button>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header1">
                                        ...
                                        <h4 class="modal-title categoryTitle"><img src="/NewEprocurement/resources/img/logo.png" alt="modal_logo"></h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="subdivisoncreate">
                                            ...
                                            <div class="col-md-12">
                                                <div class="inputfield_division" >
                                                    <form action="addnewdepartment" class="createdivison" style="padding: 28px 57px;">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <div class="text-center">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#myModaldetail">Reset</button>
                                                                </div>
                                                            </div>
                                                        </div>
 ...
 <input type="hidden" id="openModel1" data-toggle="modal" data-target="#myModaldetail"/>
        ...
        <div class="modal fade mdl-bg" id="myModaldetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <!--<form class="k-form">-->
                        <form:form  class="k-form" modelAttribute="departmentUser" action="checkdepartment" id="form" enctype="multipart/form-data">
                        <div class="modal-body"> 
                            <div class="form-group row">
                            ...
                            <div class="form-group text-center">
                                ...
                                <button type="reset" id="reset" class="btn btn-secondary btn-sm">Reset</button>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="myModaldetail1" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header1">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title categoryTitle"><img src="/NewEprocurement/resources/assets/demo/media/logo-light.png" alt="modal_logo"></h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="subdivisoncreate">
