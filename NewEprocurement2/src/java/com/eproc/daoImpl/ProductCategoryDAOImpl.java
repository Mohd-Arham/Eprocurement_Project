...
public class ProductCategoryDAOImpl implements ProductCategoryDAO<ProductCategory> {
    ...
    public String checkDuplicateValue(ProductCategory productCategory,Integer deptId) {
        ...
        String message = "";
        List<ProductCategory> ProductCategoryList = this.fetchAllProductCategorybyDept_ID(deptId);
    ...
    @Override
    public List fetchAllProductCategorybyDept_ID(Integer id) {
        System.out.println("----------------Method call to fetchAllProductCategorybyDept_ID  in  ProductCategoryDaoImpl----------------");
        List<ProductCategory> productCategoryList = new ArrayList<ProductCategory>();
        Session session=null;
        try {
             session= sessionFactory.openSession();
            Query query = session.createQuery("FROM ProductCategory where deptId=:id");
            query.setParameter("id", id);
            System.out.println("dept id ~~~"+id);
            productCategoryList = query.list();
        }catch(Exception ex){
         System.out.println("Class: ProductCategoryDaoImpl \n Method:fetchAlProductCategorybyDept_ID");
         ex.printStackTrace();
     }finally{
         if(session != null){
             session.close();
        ...
        System.out.println("----------------Method end to fetchAllProductCategorybyDept_ID  in  ProductCategoryDaoImpl----------------");
         return productCategoryList ; 
    }
    }
