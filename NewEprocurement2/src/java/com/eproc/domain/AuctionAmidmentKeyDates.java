 ...
 */
@Entity
@Table(name = "auctionamidmentkeydates_table")
public class AuctionAmidmentKeyDates implements java.io.Serializable {

    @Id
    @GeneratedValue(strategy = IDENTITY)
    @Column(name = "keyAmidmentId", unique = true, nullable = false)
    private Integer keyAmidmentId;
    ...
    public Integer getKeyAmidmentId() {
        return keyAmidmentId;
    }

    public void setKeyAmidmentId(Integer keyAmidmentId) {
        this.keyAmidmentId = keyAmidmentId;
    }
