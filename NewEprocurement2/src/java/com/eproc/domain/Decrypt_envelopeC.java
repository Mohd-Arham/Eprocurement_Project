 ...
 */
@Entity
@Table(name = "decrypt_envelopeC")
public class Decrypt_envelopeC {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "DecryptenvelopeCId")
    private int DecryptenvelopeCId;
...
//      for item rate 
    ...
    public int getDecryptenvelopeCId() {
        return DecryptenvelopeCId;
    }

    public void setDecryptenvelopeCId(int DecryptenvelopeCId) {
        this.DecryptenvelopeCId = DecryptenvelopeCId;
    }
