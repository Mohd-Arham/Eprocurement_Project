...
public class TenderKeyDates {
   ...
   @Column(name="ecBidSubmissionDate")
   private String ecBidSubmissionDate;
   ...
   private String openingECaftertechopening;
    ...
    public String toString() {
        return "TenderKeyDates{" + "keyDatesId=" + keyDatesId + ", tender_Id=" + tender_Id + ", tender_No=" + tender_No + ", tenderReleaseDate=" + tenderReleaseDate + ", tenderPurchaseDate=" + tenderPurchaseDate + ", bidSubmissionDate=" + bidSubmissionDate + ", tenderClosingDate=" + tenderClosingDate + ", openingEA=" + openingEA + ", openingEB=" + openingEB + ", openingEC=" + openingEC + ", ecBidSubmissionDate=" + ecBidSubmissionDate + ", openingECaftertechopening=" + openingECaftertechopening + '}';
    }
    ...
    public String getEcBidSubmissionDate() {
        return ecBidSubmissionDate;
    }

    public void setEcBidSubmissionDate(String ecBidSubmissionDate) {
        this.ecBidSubmissionDate = ecBidSubmissionDate;
    }
