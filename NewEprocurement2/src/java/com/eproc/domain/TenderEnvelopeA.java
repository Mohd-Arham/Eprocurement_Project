...
/**
 * <h1>TenderEnvelopeA</h1>
 * <p>This program handle the parameter of tender envelope A</p>
 * 
 * @author Gaurav Dubey
 * @since 27 Aug 2018
 * @version 2.0.0
 */
@Entity
@Table(name = "tenderenvelopea")
public class TenderEnvelopeA {
    ...
    @Transient
    private List<Boolean> labelMandatoryAList;
    ...
    public List<Boolean> getLabelMandatoryAList() {
        return labelMandatoryAList;
    }

    public void setLabelMandatoryAList(List<Boolean> labelMandatoryAList) {
    ...
    public int getEnvelopeAFieldId() {
        return envelopeAFieldId;
    }

    public void setEnvelopeAFieldId(int envelopeAFieldId) {
