...
@Entity
@Table(name="envelopea_data")
public class EnvelopeAData {
    ...
    public String toString() {
        return "EnvelopeAData{" + "envelopeAFieldId=" + envelopeAFieldId + ", fieldId=" + fieldId + ", fieldType=" + fieldType + ", fieldValue=" + fieldValue + ", fileName=" + fileName + ", convertedFileName=" + convertedFileName + ", contentType=" + contentType + ", fieldLabel=" + fieldLabel + ", templateName=" + templateName + ", tenderId=" + tenderId + ", filePath=" + filePath + ", contractorId=" + contractorId + ", bidwithDrawRemark=" + bidwithDrawRemark + ", uploadfileName=" + uploadfileName + ", uploadfileConvertedNAme=" + uploadfileConvertedNAme + ", uploadfilePath=" + uploadfilePath + ", fieldValueOfContractor=" + fieldValueOfContractor + ", departmentUserId=" + departmentUserId + ", fieldValueOfDepartmentUser=" + fieldValueOfDepartmentUser + ", departmentAdminId=" + departmentAdminId + ", fieldValueOfDepartmentAdmin=" + fieldValueOfDepartmentAdmin + ", rejectRemarkEA=" + rejectRemarkEA + ", contractor_status=" + contractor_status + ", labelMandatoryA=" + labelMandatoryA + ", requestReject=" + requestReject + ", revertStatus=" + revertStatus + ", revertDate=" + revertDate + ", revertRemark=" + revertRemark + ", openStatusOfEB=" + openStatusOfEB + ", documentOpenStatus=" + documentOpenStatus + ", twoStageEAOpenStatus=" + twoStageEAOpenStatus + ", shortListed_Status=" + shortListed_Status + ", tender_EnvelopeA_SequnceId=" + tender_EnvelopeA_SequnceId + ", fieldValueInWordsOfContractor=" + fieldValueInWordsOfContractor + ", fieldValueInWordsOfDepartmentUser=" + fieldValueInWordsOfDepartmentUser + ", fieldValueInWordsOfDepartmentAdmin=" + fieldValueInWordsOfDepartmentAdmin + ", labelTypeA=" + labelTypeA + ", labelNameA=" + labelNameA + ", reBid=" + reBid + ", bidWithdraw=" + bidWithdraw + ", file=" + file + '}';
    }
