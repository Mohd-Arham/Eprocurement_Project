...
@Entity
@Table(name="envelopeb_data")
public class EnvelopeBData {
    ...
    @Column(name="rejectRemarkEB")
    private String rejectRemarkEB;
    ...
    public String getRejectRemarkEB() {
        return rejectRemarkEB;
    }

    public void setRejectRemarkEB(String rejectRemarkEB) {
        this.rejectRemarkEB = rejectRemarkEB;
    }
