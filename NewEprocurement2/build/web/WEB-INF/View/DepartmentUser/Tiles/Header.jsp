...
<div id="k_header" class="k-header k-grid__item  k-header--fixed k-header--skin-default ">
                    ...
                    <div class="k-header__topbar">
                        ...
                        <div class="k-header__topbar-item k-header__topbar-item--search">
                            <div class="k-header__topbar-item-wrapper" data-toggle="k-tooltip" title="" data-placement="right" data-original-title="DSC Expired">
                                <span class="k-header__topbar-icon"><i class="flaticon-close k-font-danger"></i></span>
                            </div>
							<div class="k-header__topbar-item-wrapper" data-toggle="k-tooltip" title="" data-placement="left" data-original-title="About an 30 Days">
                                <span class="k-header__topbar-icon"><i class="flaticon-exclamation-1 k-font-warning"></i></span>
                            </div>
							<div class="k-header__topbar-item-wrapper" data-toggle="k-tooltip" title="" data-placement="right" data-original-title="Verified">
                                <span class="k-header__topbar-icon"><i class="la la-check-circle-o k-font-success"></i></span>
                            </div>
...
<!--                                <span class="k-header__topbar-welcome k-hidden-mobile">Hi,</span>-->
                                <span class="k-header__topbar-username k-hidden-mobile">${sessionScope.deptUserName}</span>
                                <img alt="Pic" src="<c:url value="resources/assets/media/users/300_21.jpg"/>" />
                            </div>
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-md">
                                <div class="k-user-card k-margin-b-50 k-margin-b-30-tablet-and-mobile" style="background-image: url(resources/assets/media/misc/head_bg.jpg)">
                                    <div class="k-user-card__wrapper">
                                        <div class="k-user-card__pic">
                                            <img alt="Pic" src="<c:url value="resources/assets/media/users/300_21.jpg"/>" />
                                        </div>
                                        <div class="k-user-card__details">
                                            <div class="k-user-card__name">${sessionScope.deptUserName}</div>
                                            <div class="k-user-card__position">${sessionScope.deptName}</div>
                                        </div>
                                    </div>
                                </div>
                                <ul class="k-nav k-margin-b-10">
                                    <li class="k-nav__item">
                                        <a href="deptUserProfile" class="k-nav__link">
                                    ...
                                    <li class="k-nav__item k-nav__item--custom k-margin-t-15">
                                        <a href="departmentAdminLogout" class="btn btn-outline-metal btn-hover-brand btn-upper btn-font-dark btn-sm btn-bold">Sign Out</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="k-header__topbar-item k-header__topbar--aside-secondary-toggler d-none" data-toggle="k-tooltip" title="Quick panel" data-placement="right">
