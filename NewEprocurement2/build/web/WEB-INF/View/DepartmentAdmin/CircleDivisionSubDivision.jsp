                        ...
                        <div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor">
                            ...
                            <div class="k-content__head	k-grid__item">
                                <div class="k-content__head-main">
                                    <h3 class="k-content__head-title">Circle Division SubDivision</h3>
                                        ...
                                        <div class="k-portlet alert_part circle_create"> 
                                            <div class="k-portlet__head">
                                                <div class="k-portlet__head-label">
                                                    ...
                                                    <h3 class="k-portlet__head-title">Circle</h3>
                                                </div>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                                                                    <form method="get">
                                                                        <div class="k-input-icon k-input-icon--left">
                                                                            <input type="text" value="" class="form-control" placeholder="Search..." onkeyup="myFunctionCircle()" name="search" id="search1" >
                                            ...
                                            <div class="k-portlet__body1">
                                                <div class="k-notification k-scroll k-scroller ps ps--active-y" id="circleDiv" data-scroll="true" data-height="400" style="height: 400px; overflow: hidden;">
                                                    <span class="contentNotFound">{{msg_Circle}}</span>
                                                    <a href="#" class="k-notification__item" ng-repeat="x in circles">
                                                        <div class="k-notification__item-icon" data-toggle="modal" data-target="#myModal">
                                                            <i class="la la-edit" ng-click="circleUpdate(x.circleid);"></i>
                                                        </div>
                                                        <style>  
                                                            .circle0{
                                                        ...
                                                        <div class="k-notification__item-details">
                                                            <div class="k-notification__item-title">
                                                                <!--{{x.circle}}-->
                                                                <span id="circleid" class="circle{{$index}}" role="tab" data-toggle="tab" ng-class="{'active': $index == activeTab}" ng-click="getDivision(x.circleid);">{{x.circle}}</span>
                                                            </div>
                                                ...
                                                <div class="text-center mb-2 mt-2">
                                                    <button type="button" class="btn btn-primary btn-sm" id="addCircle" data-toggle="modal" data-target="#myModal" ng-click="openModal(this.id)"><i class="flaticon-add-circular-button"></i>Add Circle</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!--end::Portlet-->
                                        ...
                                        <div class="k-portlet alert_part circle_create"> 
                                            <div class="k-portlet__head">
                                                <div class="k-portlet__head-label">
                                                    ...
                                                    <h3 class="k-portlet__head-title">Division</h3>
                                                </div>
                                                <div class="k-portlet__head-toolbar">
                                                    <div class="k-portlet__head-group">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="k-header__topbar-item k-header__topbar-item--search dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                                                                    <form method="get">
                                                                        <div class="k-input-icon k-input-icon--left">
                                                                            <input type="text" name="query" value="" class="form-control" placeholder="Search..." onkeyup="myFunctionDivision()" name="search" id="search2">
                                                                            <span class="k-input-icon__icon k-input-icon__icon--left">
                                                                                <span><i class="la la-search"></i></span>
                                                                            </span>
                                                                        </div>
                                            ...
                                            <div class="k-portlet__body1">
                                                <div class="k-notification k-scroll k-scroller ps ps--active-y" id="divisionDiv" data-scroll="true" data-height="400" style="height: 400px; overflow: hidden;">
                                                    <span class="contentNotFound">{{msg_Division}}</span>
                                                    <a href="#" class="k-notification__item" ng-repeat="y in divisions">
                                                        <div class="k-notification__item-icon" data-toggle="modal" data-target="#myModal2">
                                                            <i class="la la-edit" ng-click="divisionUpdate(y.division_id);"></i>
                                                        </div>
                                                        <style>  
                                                            .division0{
                                                                color:#5867dd  !important;
                                                        ...
                                                        <div class="k-notification__item-details">
                                                            <div class="k-notification__item-title">
                                                                <span id="division_id" class="division{{$index}}" role="tab" data-toggle="tab" ng-class="{'active': $index == activeTab}" ng-click="getSubDivision(y.division_id);">{{y.division}}</span>
                                                            </div>

                                                        </div>
                                                        <div class="k-notification__item-icon">
    <button ng-click="delete_Division(y.division_id)" style="border: none; cursor: pointer; background-color:#F3F6F4;">
        <i class="la la-archive"></i>
                                                ...
                                                <div class="text-center mb-2 mt-2">
                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" id="addDivision" data-target="#myModal2" ng-click="openModal(this.id)"><i class="flaticon-add-circular-button"></i>Add Division</button>
                                                </div>
                                            </div> 
                                        </div>
                                    </div><!--end::Portlet-->
                                        ...
                                        <div class="k-portlet alert_part circle_create"> 
                                            <div class="k-portlet__head">
                                                <div class="k-portlet__head-label">
                                                    ...
                                                    <h3 class="k-portlet__head-title">Create Sub Division</h3>
                                                </div>
                                                <div class="k-portlet__head-toolbar">
                                                    <div class="k-portlet__head-group">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="k-header__topbar-item k-header__topbar-item--search dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                                                                    <form method="get">
                                                                        <div class="k-input-icon k-input-icon--left">
                                                                            <input type="text" name="query" value="" class="form-control" placeholder="Search..." onkeyup="myFunctionSubDivision()" name="search" id="search3">
                                                                            <span class="k-input-icon__icon k-input-icon__icon--left">
                                                                                <span><i class="la la-search"></i></span>
                                                                            </span>
                                                                        </div>
                                            ...
                                            <div class="k-portlet__body1">
                                                <div class="k-notification k-scroll k-scroller ps ps--active-y" id="subdivisionDiv" data-scroll="true" data-height="400" style="height: 400px; overflow: hidden;">
                                                    <span class="contentNotFound">{{msg_SubDivision}}</span>
                                                    <a href="#" class="k-notification__item" ng-repeat="z in subdivisions">
                                                        <div class="k-notification__item-icon" data-toggle="modal" data-target="#myModal3">
                                                            <i class="la la-edit" ng-click="subDivisionUpdate(z.subdivision_id);"></i>
                                                        </div>
                                                        <style>  
                                                            .subdivision0{
                                                                color:#5867dd  !important;
                                                        ...
                                                        <div class="k-notification__item-details">
                                                            <div class="k-notification__item-title">
                                                                <span id="subdivision_id" class="subdivision{{$index}}" role="tab" data-toggle="tab" ng-class="{'active': $index == activeTab}">{{z.subdivision}}</span>
                                                            </div>
                                                        </div>
                                                        <div class="k-notification__item-icon">
    <button ng-click="delete_SubDivision(z.subdivision_id)" style="border: none; cursor: pointer; background-color:#F3F6F4;">
        <i class="la la-archive"></i>
    </button>
</div>
                                                    </a> 
                                                ...
                                                <div class="text-center mb-2 mt-2">
                                                    <button type="button" class="btn btn-primary btn-sm" id="addSubDivision" data-toggle="modal" data-target="#myModal3" ng-click="openModal(this.id)"><i class="flaticon-add-circular-button"></i>Add Sub Division</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal fade mdl-bg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form:form class="k-form" modelAttribute="circle" id="formid">
                        <div class="modal-body">
                            <form:hidden path="circleid" id="idcircle"/>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">Circle Name</label>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <form:input path="circle"  id="target1" class="form-control" aria-describedby="emailHelp" placeholder=""/>
                                    <span id="errorCircle"></span>
                                    <span class="ValidationMsg" id="circle_nameError" style="color:red"></span>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success btn-sm" ng-click="saveCircle()">Add</button>
                            <button type="button" class="btn btn-primary btn-sm">Reset</button>
                            <button type="button" class="btn btn-secondary btn-sm" id="circleBTN" data-dismiss="modal">Close</button>
                        </div>
                    </form:form>
                </div>
            </div>
        ...
        <div class="modal fade mdl-bg" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form:form action="#" class="k-form" modelAttribute="division"  id="divisionForm">
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">Circle Name</label>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <form:hidden path="division_id" id="division_id"/>
                                    <form:select path="circleid" id="circle1" class="form-control">
                                        <%--<form:option value="">Select</form:option>--%>
                                        <form:option ng-repeat="x in circles" value="{{x.circleid}}">{{x.circle}}</form:option>
                                    </form:select>
                                    <span class="ValidationMsg" id="circle_nameError1" style="color:red"></span>
                                    <span id="errorCircleDivision"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    <form:input path="division" class="form-control" placeholder="Enter Division" id="division_name"  style="text-transform: uppercase;"/>
                                    <span  id="division_nameError1" style="color:red"></span>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success btn-sm" ng-click="saveDivision();">Add</button>
                            <button type="button" class="btn btn-primary btn-sm">Reset</button>
                            <button type="button" class="btn btn-secondary btn-sm" id="divisionBTN" data-dismiss="modal">Close</button>
                        </div>
                    </form:form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header pd-header">
                        <h5 class="modal-title logo-modal"> 
                            ...
                            <span class="dpt_name_logo">Create Sub Division</span></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form:form action="#" class="k-form" modelAttribute="subdivision" id="subDivisionForm">
                        <div class="modal-body">
                            <div class="form-group row">
                                <form:hidden path="division_id" id="iddivision"/>
                                <form:hidden path="subdivision_id" id="id_subdivision"/>
                                <label class="col-form-label col-lg-3 col-sm-12">Circle Name</label>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <form:select path="circleid" id="circle10" onchange="myFunction()" class="form-control ">
                                        <form:option value="" >Select</form:option>
                                        <form:option ng-repeat="x in circles" value="{{x.circleid}}">{{x.circle}}</form:option>
                                    </form:select>
                                    <span id="errorCircleName"></span>
                                    <span id="circle_nameError2" style="color:red"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">Division Name</label>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <form:select path="division_id" id="division1" class="form-control">
                                        <form:option value="">Select</form:option>
                                    </form:select>
                                    <span id="errorDivisionName"></span>
                                    <span id="division_nameError2" style="color:red"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3 col-sm-12">SubDivision Name</label>
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <form:input path="subdivision" class="form-control" placeholder="Enter SubDivision"  id="subdivision_name"  style="text-transform: uppercase;"/>
                                    <span id="errorSubDivision"></span>
                                    <span id="subdivision_nameError2" style="color:red"></span>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success btn-sm" ng-click="saveSubDivision();">Add</button>
                            <button type="reset" class="btn btn-primary btn-sm">Reset</button>
                            <button type="button" class="btn btn-secondary btn-sm" id="subdivBTN" data-dismiss="modal">Close</button>
                        </div>
                    </form:form>
                </div>
            </div>
        ...
        <script>
                    ...
                    function circleValidation() {
                        alert("validation called");
//                         var alphNumerc = new RegExp('[A-Za-z ]+$');
                        var alphNumerc = /'[A-Za-z ]+$'/;
                        var countError = 0;
                        var circle = $("#target1").val();
                        circle = circle.trim();
                        if (circle === null || circle === "") {
                            $("#errorCircle").css('color', 'red');
                            $("#errorCircle").html("Please Enter Circle Name");
                            countError++;
                        }
//        else if (circle !== alphNumerc) {
//                            alert("alphNumerc");
//                            $("#errorCircle").css('color', 'red');
//                            $("#errorCircle").html("Special Symboles are not allowed");
//                            countError++;
//                        }                 
                        else {
                            $("#errorCircle").html("");
                    ...
                    function divisionValidation() {
                        ...
                        if (circle === null || circle === "") {
                            $("#errorCircleDivision").css('color', 'red');
                            $("#errorCircleDivision").html("Please select Circle Name");
                            countError++;
                        } else {
                            $("#errorCircleDivision").html("");
                        }
                        if (division === null || division === "") {
                            $("#errorDivision").css('color', 'red');
                            $("#errorDivision").html("Please Enter Division Name");
                            countError++;
                        }
...
//                        } 
                    ...
                    function subDivisionValidation() {
                        ...
                        var alphNumerc = /'[A-Za-z ]+$'/;
                        var countError = 0;
                        var circle = $("#circle10").val();
                        var division = $("#division1").val();
                        var subdivision = $("#subdivision_name").val();
                        alert(division + " division");
                        if (circle === null || circle === "") {
                            $("#errorCircleName").css('color', 'red');
                            $("#errorCircleName").html("Please select Circle Name");
                            countError++;
                        } else {
                            $("#errorCircleName").html("");
                        }
                        if (division === '-1' || division === "") {
                            $("#errorDivisionName").css('color', 'red');
                            $("#errorDivisionName").html("Please select Division Name");
                            countError++;
                        } else {
                            $("#errorDivisionName").html("");
                        }
                        if (subdivision === null || subdivision === "") {
                            $("#errorSubDivision").css('color', 'red');
                            $("#errorSubDivision").html("Please Enter SubDivision Name");
                            countError++;
                        } else {
                            $("#errorSubDivision").html("");
                        }
                        return countError;
                    }
        ...
        function myFunctionCircle() {
            ...
            div = document.getElementById("circleDiv");
        ...
        function myFunctionDivision() {
            ...
            filter = input.value.toUpperCase();
            div = document.getElementById("divisionDiv");
            a = div.getElementsByTagName("a");
            for (i = 0; i < a.length; i++) {
                span = a[i].getElementsByTagName("span")[0];
                if (span.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        function myFunctionSubDivision() {
           var input, filter,a,i,div,span;
            input = document.getElementById("search3");
            filter = input.value.toUpperCase();
            div = document.getElementById("subdivisionDiv");
            a = div.getElementsByTagName("a");
            for (i = 0; i < a.length; i++) {
                span = a[i].getElementsByTagName("span")[0];
                if (span.innerHTML.toUpperCase().indexOf(filter) > -1) {
