...
<div class="modal fade mdl_bg mdl_frm" data-backdrop="static" id="otpModalforDeptAdmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="k-login-v2__body-wrapper">
                                <div class="k-login-v2__body-container">
                                    <div class="k-login-v2__body-title">
                                     ...
                                     <!--begin::Form-->
                                       <form id="verifyOTP" role="form" class="k-login-v2__body-form k-form k-login-v2__body-form--border">
                                      <div class="verify_imgicn text-center">
                                       <i class="flaticon-chat-1"></i>
                                        ...
                                        <div class="form-group">
                                             <input type="hidden" id="generatedotp1" name="generatedotp" value="">
                                             <input type="hidden" id="otpFor" name="otpFor"  value="forupdate">
                                             ...
                                             <button type="button"  class="btn btn-pill btn-brand btn-elevate"  onclick="otpMatch1();" >Verify</button>
                                         </div>
...
//            alert("otpMatch "+otpMatch);
           ...
           if(otpMatch==true){
               $.ajax({
             url: "matchOTPAdmin?enteredOtp="+enteredOtp,
