    ...
    <div class="k-header__topbar">
        ...
        <div class="k-header__topbar-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <div class="k-head" style="background-image: url(resources/assets/media/misc/head_bg.jpg)">
        ...
        <div class="k-header__topbar-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <div class="k-head" style="background-image: url(resources/assets/media/misc/head_bg_sm.jpg)">
                ...
                <div class="k-grid-nav"> 
                    ...
                    <a href="#" class="k-grid-nav__item">
                        ...
                        <div class="k-grid-nav__item-title">Settings</div>
        ...
        <div class="k-header__topbar-item k-header__topbar-item--user">
            <div class="k-header__topbar-item-wrapper" data-toggle="dropdown" data-offset="10px -2px">
                ...
                <span class="k-header__topbar-username k-hidden-mobile">${sessionScope.deptAdminName}</span>
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-md">
                <div class="k-user-card k-margin-b-50 k-margin-b-30-tablet-and-mobile" style="background-image: url(resources/assets/media/misc/head_bg.jpg)">
                    <div class="k-user-card__wrapper">
                        ...
                        <div class="k-user-card__details">
                            <div class="k-user-card__name">${sessionScope.deptAdminName}</div>
                ...
                <ul class="k-nav k-margin-b-10">
                    <li class="k-nav__item">
                        <a href="deptadminprofile" class="k-nav__link">
                    ...
                    <li class="k-nav__item k-nav__item--custom k-margin-t-15">
                        <a href="logoutDeptAdmin" class="btn btn-outline-metal btn-hover-brand btn-upper btn-font-dark btn-sm btn-bold">Sign Out</a>
                    </li>
                </ul>
            </div>
        </div>
