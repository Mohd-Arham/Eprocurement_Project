<div class="k-aside-menu-wrapper	k-grid__item k-grid__item--fluid" id="k_aside_menu_wrapper">
    <div id="k_aside_menu" class="k-aside-menu " data-kmenu-vertical="1" data-kmenu-scroll="1" data-kmenu-dropdown-timeout="500" style="position: relative;">
        <ul class="k-menu__nav " style="padding-top:4px;">
            ...
            <li class="k-menu__item  k-menu__item--submenu k-menu__item--open k-menu__item--expanded" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="contractorDashboard" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon flaticon-line-graph"></i><span class="k-menu__link-text">Dashboards</span></a>
            </li>
            ...
            <li class="k-menu__item  k-menu__item--submenu" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="myTender" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon la la-map-signs"></i><span class="k-menu__link-text">My Tender</span></a>
            </li>
            ...
            <li class="k-menu__item  k-menu__item--submenu" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="liveTenderAuction" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon la la-cubes"></i><span class="k-menu__link-text">Live Tender</span></a>
            </li>
...
<!--                                    <li class="k-menu__item  k-menu__item--submenu" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="ManageContractor?id=${regId}" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon flaticon-tabs"></i><span class="k-menu__link-text">Manage User</span><i class="k-menu__ver-arrow la la-angle-right"></i></a>
            ...
            <li class="k-menu__item  k-menu__item--submenu" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="javascript:;" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon la la-cubes"></i><span class="k-menu__link-text">Change Password</span></a>
            </li>
            <div class="k-menu__submenu "><span class="k-menu__arrow"></span>
                <ul class="k-menu__subnav">
